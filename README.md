...
![Streamlit Overview](docs/images/streamlit_dashboard.png)

> **Live metrics: 99.40% accuracy | 100 tasks | Digital Twin active | 61.4% offloading**

---

### Grafana — Advanced Traffic Analytics

![Grafana Advanced Traffic](docs/images/grafana_advanced_traffic.png)

> **Vehicle CPU: 28% | Battery: 52.5% | Network Latency: 93ms | Edge Server Load: 95**

---

### Grafana — Task Distribution & RL Reward

![Grafana Task Distribution](docs/images/grafana_task_distribution.png)

> **Decision Distribution: 76% Edge, 24% Vehicle | Avg RL Reward: 53.1 | SUMO Tasks: 1,304**

---

### Grafana — Digital Twin Monitoring

![Grafana Digital Twin](docs/images/grafana_digital_twin.png)

> **Avg Edge CPU: 49.7% | Avg Cloud Latency: 83ms | Twin Vehicle Battery: 54.6%**

---

### Grafana — Predictive Intelligence

![Grafana Predictive](docs/images/grafana_predictive.png)

> **Predicted Congestion: 80.3 | Edge Load: 62.4% | Cloud Latency: 101ms | Battery Drain: 46.8%**

---

### Grafana — Self-Adaptive Control Loop

![Grafana Self-Adaptive](docs/images/grafana_self_adaptive.png)

> **Adaptive Records: 700 | Overrides: 87 | Override Rate: 12.4% | Final EDGE Decisions: 291**
...
```bash
git clone https://github.com/<YOUR_USERNAME>/automotive-edge-cloud-orchestration.git
cd automotive-edge-cloud-orchestration
```
...
- `automotive-streamlit`
- `automotive-prometheus`
- `automotive-grafana`
...
| Core Metrics Exporter | http://localhost:8000/metrics |
| Self-Adaptive Exporter | http://localhost:8008/metrics |
